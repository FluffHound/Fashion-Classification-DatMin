...
intro_col_left.image('FashioniFy.png')
...
st.markdown('<hr>', unsafe_allow_html=True)
intro_col_left1.image('bag.jpg', caption="Bags")
intro_col_right1.image('belt.png', caption="Belt")
intro_col_left2.image('Boots.png', caption="Boots")
intro_col_right2.image('dress.png', caption="Dresses")

intro_col_left1.image('topi.png', caption="Hats")
intro_col_right1.image('jackets and coats.png', caption="Jackets and Coats")
intro_col_left2.image('jewelry.png', caption="Jewelry")
intro_col_right2.image('knitwear.png', caption="Knitwear")

intro_col_left1.image('loafers.png', caption="Loafers")
intro_col_right1.image('pants.png', caption="Pants")
intro_col_left2.image('sendals.png', caption="Sandals")
intro_col_right2.image('scarves.png', caption="Scarves")

intro_col_left1.image('skirt.png', caption="Skirt")
intro_col_right1.image('sneakers.png', caption="Sneaker")
intro_col_left2.image('sunglasses.png', caption="Sunglasses")
intro_col_right2.image('T-shirt.png', caption="T-shirt")
